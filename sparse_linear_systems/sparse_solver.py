...
def coo_torch2cupy(A):
    ...
    return cp.sparse.coo_matrix((Avals_cp, Aidx_cp), shape=A.shape)
...
if __name__ == "__main__":
    ...
    print("#######################  Start: Test matrix-vector solver  ##############################")
    ...
    print('A.grad', A.grad)
    print('b.grad', b.grad)
    print("#######################  End: Test matrix-vector solver  ##############################")



    print("#######################  Start: Test matrix-matrix solver  ##############################")
    ...
    print("#######################  End: Test matrix-matrix solver  ##############################")
    ...
    torch.autograd.gradcheck(sparse_solve, [A, b], masked=True, raise_exception=True, check_undefined_grad=False)